...
/***/ function(module, exports, __webpack_require__) {
	...
	var _timeseries = __webpack_require__(1);

	var _timeseries2 = _interopRequireDefault(_timeseries);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var graph = new _timeseries2.default();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timeseries = function () {
	  ...
	  function Timeseries() {
	    ...
	    /**
	     * The default marigns of the graph
	     ...
	     * @type {number}
	     */
	    this._width = config.width || document.querySelector(this._querySelector).clientWidth - this._margins.left - this._margins.right;
	     ...
	     * @type {number}
	     */
	    this._height = config.height || this._width / 2 - this._margins.top - this._margins.bottom;

	    /**
	     * The x scaling function
	     * @default d3.time scale from 0 to the width
	     * @type {function}
	     */
	    this._xScale = config.xScale || _d2.default.time.scale().range([0, width]);

	    /**
	     * The x axis on the bottom
	     * @type {function}
	     */
	    this._xAxis = _d2.default.svg.axis().scale(this._xScale).orient('bottom');

	    /**
	     * The y scaling function
	     * @default d3.liner from the hight to 0
	     * @type {function}
	     */
	    this._yScale = config.yScale || _d2.default.scale.linear().range([height, 0]);

	    /**
	     * The y axis on the left
	     * @type {function}
	     */
	    this._yAxis = _d2.default.svg.axis.scale(this._yScale).orient('left');
	     ...
	     * @type {function}
	     */
	    this._line = _d2.default.svg.line().x(function (d) {
	      return _this._xScale(d.x);
	    }).y(function (d) {
	     ...
	     * @type {d3}
	     */
	    this._svg = _d2.default.select(this._querySelector).append('svg').attr('width', this._width + this._margins.left + this._margins.right).attr('height', this._height + this._margins.top + this._margins.bottom).append('g').attr('transform', 'translate(' + this._margins.left + ',' + this._margins.top + ')');
	  }
	  ...
	  _createClass(Timeseries, [{
	    key: 'addData',
	    value: function addData(name, x, y) {
	      this._data.push({
	        name: name,
	        x: x,
	        y: y
